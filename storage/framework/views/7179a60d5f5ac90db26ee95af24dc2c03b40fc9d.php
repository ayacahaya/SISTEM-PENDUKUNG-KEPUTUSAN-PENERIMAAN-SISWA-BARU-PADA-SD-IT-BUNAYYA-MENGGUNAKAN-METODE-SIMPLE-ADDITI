  ...
  <div class="col">
    <div class="card">
      <div class="card-header border-0">
        <h3 class="mb-0"><i class="fas fa-table mr-1"></i>Tabel Hasil</h3>
        <div class="col-lg-12 col-12 text-right">
          <a href="<?php echo e(route('hasil.cetak_pdf')); ?>" class="btn btn-sm btn-primary"><i class="fas fa-file-pdf"></i> Cetak Pdf</a>
        </div>
      </div>
          <!-- <div class="card"> -->
            <!-- Card header -->
...
<?php echo $__env->make('template.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sistem-penerimaan-siswa-baru\resources\views/admin/hasil/index.blade.php ENDPATH**/ ?>